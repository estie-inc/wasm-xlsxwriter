...
impl Format {
    ...
    pub fn set_border_color(&self, color: Color) -> Format {
        impl_method!(self.set_border_color(xlsx::Color::from(color)));
    }
    ...
    pub fn set_border_bottom_color(&self, color: Color) -> Format {
        impl_method!(self.set_border_bottom_color(xlsx::Color::from(color)));
    }
    ...
    pub fn set_border_top_color(&self, color: Color) -> Format {
        impl_method!(self.set_border_top_color(xlsx::Color::from(color)));
    }
    ...
    pub fn set_border_left_color(&self, color: Color) -> Format {
        impl_method!(self.set_border_left_color(xlsx::Color::from(color)));
    }
    ...
    pub fn set_border_right_color(&self, color: Color) -> Format {
        impl_method!(self.set_border_right_color(xlsx::Color::from(color)));
    }
    ...
    pub fn set_border_diagonal_color(&self, color: Color) -> Format {
        impl_method!(self.set_border_diagonal_color(xlsx::Color::from(color)));
    }
    ...
    pub fn set_font_color(&self, color: Color) -> Format {
        impl_method!(self.set_font_color(xlsx::Color::from(color)));
    }
    ...
    pub fn set_foreground_color(&self, color: Color) -> Format {
        impl_method!(self.set_foreground_color(xlsx::Color::from(color)));
    }
    ...
    pub fn set_background_color(&self, color: Color) -> Format {
        impl_method!(self.set_background_color(xlsx::Color::from(color)));
    }
